...
Comprehensive documentation for the SteelAxis multi-tenant steel fabrication management system built with .NET 8.0, Blazor Server, MudBlazor, and Microsoft Entra External ID.
...
- **[steelaxis-strategic-guide.md](./general/steelaxis-strategic-guide.md)** - Strategic product vision reference
- **[steelaxis-development-roadmap.md](./general/steelaxis-development-roadmap.md)** - Development roadmap reference
